...
input_directory_MedianSigmBg <- "~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Dr Stec/PTK/input_data/_Export_Median_SigmBg_220724140300.txt"

input_directory_Signal_Saturation <- "~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Dr Stec/PTK/input_data/_Export_Signal_Saturation_220724140300.txt"

#experiment_ID

experiment_ID <- "Dr_Stec_HepPPARaKO_v_FloxPPARa_PTK"

#comparison variables

name_in_input_groupA <- "Hep PPARaKO"
shorthand_groupA <- "exp"
name_in_input_groupB <- "Flox PPARa"
...
kinases_of_interest <-c("HER3", "FGFR2", "FGFR3", "TRKA", "TRKC", "Fyn", "IRR", "TRKB", "Fer", "Lck", "EphA1", "EphA2", "EphA3", "Syk", "Lyn", "FGFR1", "KDR", "DDR1", "FLT4")
...
### Hep PPARaKO vs Flox PPARa (Heatmap)
...
### Hep PPARaKO vs Flox PPARa (Violin Plot)
...
### Hep PPARaKO vs Flox PPARa (Waterfall Plot)
...
### Hep PPARaKO vs Flox PPARa (Curve Plot)
...
### Hep PPARaKO vs Flox PPARa (Upstream Kinase Analysis (UKA) - Kinase Families)
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig1-TRK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "TRK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig2-FGFR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig3-EPH","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "EPH")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig4-DDR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "DDR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig5-VEGFR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "VEGFR")
dev.off()
...
### Hep PPARaKO vs Flox PPARa (Reverse KRSA Plot)
...
### Hep PPARaKO vs Flox PPARa (Coverage Plot)
...
### Hep PPARaKO vs Flox PPARa (Ball Model Network)
...
### Hep PPARaKO vs Flox PPARa (Upstream Kinase Analysis (UKA) - Individual Kinases)
...
# waterfall plot 
  ...
  filter(Kin %in% kinases_of_interest[22:23]) %>% 
  krsa_waterfall(0.2) +
...
```{r perpeptidePlot, echo=F, fig.align="center", fig.height=8,fig.width=8, cache=TRUE}

# per peptide plot with color representing kinase rank  
# mapped_lfc_table %>% 
#   filter(Kin %in% kinases_of_interest[1]) %>% 
#   ggplot(aes(LFC, reorder(Peptide, totalMeanLFC))) +
#   geom_vline(xintercept = 0) +
#   geom_line(aes(color = `Mapping Confidence`), size = 2) +
#   geom_point() +
#   geom_point(aes(totalMeanLFC, reorder(Peptide, totalMeanLFC)), size = 1.5) +
#   facet_wrap(~Kin, scales = "free_y") +
#   labs(y = NULL) +
#   theme(
...
### Hep PPARaKO vs Flox PPARa (Upstream Kinase Analysis - Individual Kinases)
...
## ^ need a new processed_uka_map that has duplicate peptides filtered out

#krsa(sigPeps$meanLFC$`0.2`, return_count = T, seed = 123, itr = 10000,
#     map_file = KRSA_file, cov_file = processed_uka_map) -> fin
...
### Hep PPARaKO vs Flox PPARa (Z Scores Plot)
...
### Hep PPARaKO vs Flox PPARa individual kinases - Generate peacock plots
...
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, c("HER3", "FGFR2", "FGFR3", "TRKA", "TRKC", "Fyn", "IRR", "TRKB", "Fer", "Lck", "EphA1", "EphA2", "EphA3", "Syk", "Lyn", "FGFR1", "KDR", "FLT3", "DDR1"))

png(file = (paste0(EAB_directory_output_comparison, "Fig1-HER3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HER3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig2-FGFR2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig3-FGFR3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig4-TRKA","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "TRKA")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig5-TRKC","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "TRKC")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig6-Fyn","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Fyn")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig7-IRR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "IRR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig9-TRKB","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "TRKB")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig10-Fer","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Fer")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig11-Lck","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Lck")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig12-EphA1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "EphA1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig13-EphA2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "EphA2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig14-EphA3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "EphA3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig15-Syk","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Syk")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig16-Lyn","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Lyn")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig17-FGFR1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig18-KDR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "KDR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig19-DDR1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "DDR1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig20-FLT4","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FLT4")
dev.off()
```
